    ...
    <div className="flex flex-col items-center">
      ...
      >
        <div className="md:max-w-3xl text-center px-4">
          ...
          >
            We design and build modern software, AI agents, and digital platforms — combining innovation, security, and design into one powerful experience.
          </motion.p>
          ...
          >
            ...
            <motion.a
              href="https://calendly.com/devaxissolutions/30min"
              target="_blank"
